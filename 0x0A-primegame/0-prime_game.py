...
and including n,they take turns choosing a prime number from the
...
def isWinner(x, nums):
    ...
    def canWin(n):
        ...
        for i in range(2, n + 1):
            # If the curent number is prime and there exists a move
            # such that Maria loses, then Ben wins
